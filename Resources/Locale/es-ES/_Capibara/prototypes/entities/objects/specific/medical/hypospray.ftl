ent-Hypospray = hypospray
    .desc = Un inyector estéril para administración rápida de medicamentos a pacientes.

ent-SyndiHypo = hypospray gorlex
...
ent-BorgHypo = borghypo
    .desc = Un inyector estéril para administración rápida de medicamentos a pacientes. Una versión más barata y especializada para borgs médicos.

ent-AdminHypo = hypospray experimental
    .desc = La aplicación definitiva de la tecnología bluespace y la administración química rápida.
...
ent-StimpackMini = microinyector de hiperzina
    .desc = Un microinyector de hiperzina que te da unos 15 segundos de los efectos del químico.

ent-CombatMedipen = medipen de combate
    .desc = Un medipen de un solo uso que contiene químicos que regeneran la mayoría de los tipos de daño.

ent-Hypopen = bolígrafo
    .desc = Un bolígrafo de tinta oscura.

ent-HypopenBox = caja de hypo-bolígrafo
    .desc = Una pequeña caja que contiene un hypo-bolígrafo. El embalaje se desintegra al abrirlo, sin dejar evidencia.

ent-WehMedipen = autoinyector weh
    .desc = Una dosis rápida de Weh. Contiene jugo que te hace Weh.
