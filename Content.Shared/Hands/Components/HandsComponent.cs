...
public partial record struct Hand
{
    ...
    // Hispania: xenoborg port — hand whitelists for restricted pickup slots
    /// <summary>
    ...
    public Hand(HandLocation location, LocId? emptyLabel, EntProtoId? emptyRepresentative, EntityWhitelist? whitelist, EntityWhitelist? blacklist)
    {
        Location = location;
